export const projects = [
  ...
  },
  {
    ...
    details:
      "Aplicação web completa que funciona como um diretório digital para a cidade de Paragominas. Permite aos usuários encontrar facilmente estabelecimentos, serviços e informações locais, com sistema de busca e categorização.",
  },
  {
    name: "ZapBot",
    slug: "zapbot",
  ...
  },
  {
    ...
    details:
      "Plataforma de blog moderna que utiliza MDX para criar conteúdo rico e interativo. Permite a integração de componentes React diretamente nos artigos, oferecendo uma experiência de leitura dinâmica e personalizada.",
  },
  {
